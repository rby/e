...
object_expr -> 'def' identifier behavior: {object, "", '$2', [], '$3'}.
object_expr -> 'def' identifier auditors behavior: {object, "", '$2', '$3', '$4'}.
...
auditors -> 'implements' e_exprs: '$2'.

emethod -> 'method' verb '(' patterns ')' ':' e_expr '{'
		seq_expr 
	   '}': {emethod, "", '$2', '$4', '$7', '$9'}.
